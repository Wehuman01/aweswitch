...
class AweSwitchTests(unittest.TestCase):
    ...
    def test_usage_progress_helpers(self):
        ...
        self.assertEqual(aweswitch._usage_compact_count(25.5), "25.5")
        self.assertEqual(aweswitch._usage_compact_count(19.99), "19.99")
        ...
        self.assertEqual(aweswitch._usage_credits_text({"balance": 19.55}), "balance 19.55")
